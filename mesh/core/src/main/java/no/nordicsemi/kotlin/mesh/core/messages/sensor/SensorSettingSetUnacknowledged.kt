...
/**
 * This message is used to set the Sensor Setting state of a sensor setting. This message is not acknowledged.
 *
 ...
 *                             is not known.
 */
class SensorSettingSetUnacknowledged(
    ...
    override fun toString() = "SensorSettingSetUnacknowledged(property: ${
        ...
        override fun init(parameters: ByteArray?) = parameters
            ...
            ?.let { params ->
                ...
                when {
                    ...
                    else -> SensorSettingSetUnacknowledged(
