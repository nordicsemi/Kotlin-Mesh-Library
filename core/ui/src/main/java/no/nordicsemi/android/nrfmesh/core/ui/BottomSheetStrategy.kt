...
import no.nordicsemi.android.nrfmesh.core.ui.BottomSheetSceneStrategy.Companion.bottomSheet

/**
 * An [OverlayScene] that renders an [entry] within a [ModalBottomSheet].
 *
 * Found on https://github.com/android/nav3-recipes/blob/main/app/src/main/java/com/example/nav3recipes/bottomsheet/BottomSheetSceneStrategy.kt
 *
 */
